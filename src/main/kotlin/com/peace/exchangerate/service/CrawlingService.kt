...
import com.peace.exchangerate.client.SlackClient
...
class CrawlingService(
    ...
    fun sendExchangeRateInfoToSlack() {
        val crawlingExchangeRate = crawlingExchangeRate()
        slackClient.sendMessage(crawlingExchangeRate.toString())
    }
